...
> 按"能力组"分组组织 FR。每条 FR 用 6 字段格式。

### 5.1 能力组 A：<能力组名称>

#### FR-001 <祈使句标题，如"模板工作台管理">
...
> 在 PRD 末尾给 fs-writer 一些起草建议，避免下游团队再重新讨论拆分。

- **建议合并为一份 FS 的 FR**：<列出紧耦合的 FR 编号>
- **必须独立成 FS 的 FR**：<列出有独立状态机或独立 API 域的 FR>
- **仅需 schema 预留的 P2 FR**：<列出未来才实现的 FR>
